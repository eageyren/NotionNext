...
const BLOG = {
  API_BASE_URL: process.env.API_BASE_URL || 'https://dark-wound-53b.notion.site/api/v3', // API默认请求地址,可以配置成自己的地址例如：https://[xxxxx].notion.site/api/v3
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'EageYren', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '灰烬之叶', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://www.eageyren.top/', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '兰州理工大学,期末备考,软件工程专业', // 网站关键词 英文逗号隔开
