...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'FREEDOM', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '兰州理工大学软件工程某学生', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://eageyren.edu.deal', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '学习, 兰理工', // 网站关键词 英文逗号隔开
