...
const BLOG = {
  ...
  BIO: process.env.NEXT_PUBLIC_BIO || 'EmberLeaf | 灰烬之叶', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://eageyren.edu.deal/', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '兰州理工大学,NotionNext', // 网站关键词 英文逗号隔开
